...
const ContactForm = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 py-10 sm:py-10 px-4 sm:px-5 lg:px-6 mt-20 sm:mt-20 relative overflow-hidden">
